...
export class umrahlaborDto implements IumrahlaborDto {
	marketCode: string;
	analyst: string;
    ndoDesc: string;
    codeDesc: string;
    ...
    static fromJS(data: any): umrahlaborDto {
        let result = new umrahlaborDto();
        result.init(data);
        return result;
    }

    constructor(data?: IumrahlaborDto) {
        if (data) {
...
export interface IumrahlaborDto {
	marketCode: string;
	analyst: string;
    ndoDesc: string;
    codeDesc: string;
...
export class PagedResultDtoOfumrahlaborDto implements IPagedResultDtoOfumrahlaborDto {
    totalCount: number;
    items: umrahlaborDto[];

    static fromJS(data: any): PagedResultDtoOfumrahlaborDto {
        let result = new PagedResultDtoOfumrahlaborDto();
        result.init(data);
        return result;
    }

    constructor(data?: IPagedResultDtoOfumrahlaborDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property)) {
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data['items'] && data['items'].constructor === Array) {
                ...
                for (let item of data['items']) {
                    this.items.push(umrahlaborDto.fromJS(item));
                }
            }
        }
    }
...
export interface IPagedResultDtoOfumrahlaborDto {
    totalCount: number;
    items: umrahlaborDto[];
}
