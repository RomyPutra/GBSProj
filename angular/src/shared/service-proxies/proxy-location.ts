...
export class LocationServiceProxy {
     ...
     * @return Success
     */
    getListEntity(skipCount: number, maxResultCount: number, bizRegID?: string, empID?: string): Observable<PagedResultDtoOfLocationDto> {
        let url_ = this.baseUrl + '/api/eswis/Location/GetListEntity?';
        ...
        return this.http.request(url_, options_).flatMap((response_: any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfLocationDto>><any>Observable.throw(e);
                }
            } else {
                return <Observable<PagedResultDtoOfLocationDto>><any>Observable.throw(response_);
            }
        });
    }

    protected processGetListEntity(response: Response): Observable<PagedResultDtoOfLocationDto> {
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? PagedResultDtoOfLocationDto.fromJS(resultData200) : new PagedResultDtoOfLocationDto();
        ...
        return Observable.of<PagedResultDtoOfLocationDto>(<any>null);
    }
}
