...
#Region "Data select"
        Public Shared Function CustomSelect(ByVal ConnString As String, ByVal CustomType As EnumCustomSelect, Optional ByVal CustomCriteria As String = Nothing, Optional ByVal CustomCriteria2 As String = Nothing, Optional ByVal CustomCriteria3 As String = Nothing, Optional ByVal TypeOrder As EnumTypeOrder = EnumTypeOrder.ByCode) As DataSet
            ...
            Dim conn As DataAccess = New DataAccess()
            ...
            Select Case CustomType
                ...
                Case EnumCustomSelect.StockCategory
                    strSQL = "SELECT STKCATEGORY.CatgCode, STKCATEGORY.CatgDesc, STKDEPARTMENT.DeptDesc, STKCATEGORY.DeptCode " & _
                            "FROM STKCATEGORY INNER JOIN STKDEPARTMENT ON STKCATEGORY.DeptCode = STKDEPARTMENT.DeptCode " & _
                ...
                Case EnumCustomSelect.CustomerCategory
                    strSQL = "SELECT cuscatid as CUSCATGID,cuscatdesc as DES, CASE privilegecode WHEN NULL THEN 'NO' ELSE 'YES' END AS PRIVILEGECODE FROM custcategory " & _
                ...
                Case EnumCustomSelect.RptBranch
                    strSQL = "SELECT BranchID, BranchName FROM SysBranch WHERE Flag = 1 " & _
...
#End Region
        ...
        Public Shared Function FillBranchInfo(ByRef objConn As DataAccess, ByRef objBranch As BranchBase, _
...
#Region "ErrorLog "
    Public Class ErrorLog
        ...
        Private Sub ProcessErrorLog(ByVal ex As Exception, _
        ...
        Public Sub SaveExceptionToLog(ByVal ex As Exception, _
