...
namespace Plexform
{
    ...
    public class PlexformWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PlexformWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PlexformWebCoreModule).GetAssembly());
        }
    }
}
