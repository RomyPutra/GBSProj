<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DetailBreakdownPerpax.ascx.cs" Inherits="GroupBooking.Web.UserControl.DetailBreakdownPerpax" %>
                        ...
                        <table width="100%" bgcolor="#f7f3f7" class="table table-bordered" id="tblFareBreakdown" runat="server">
                            <tr id="trConnecting" runat="server">
                                <td id="tdConnectingDepart" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="Label1" runat="server"></asp:Label>Connecting Charge per Pax<asp:Label ID="Label2" runat="server" Visible="false"></asp:Label>
                                ...
                                <td id="tdConnectingReturn" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="Label6" runat="server">Connecting Charge per Pax</asp:Label><asp:Label ID="Label7" runat="server" Visible="false"></asp:Label>
                            ...
                            <tr id="trKlia2" runat="server">
                                <td id="tdDepartKlia2" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_num2" runat="server">Klia2 Fee per Pax </asp:Label><asp:Label ID="lbl_taxPrice" runat="server" Visible="false"></asp:Label>
                                ...
                                <td id="tdReturnKlia2" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_InNum2" runat="server">Klia2 Fee per Pax </asp:Label><asp:Label ID="lbl_IntaxPrice" runat="server" Visible="false"></asp:Label>
                            ...
                            <tr id="trGST" runat="server">
                                <td id="tdDepartGST" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_num21" runat="server"></asp:Label>GST Charge per Pax<asp:Label ID="lbl_PaxFeePrice" runat="server" Visible="false"></asp:Label>
                                ...
                                <td id="tdReturnGST" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_InNum21" runat="server">GST Charge per Pax</asp:Label><asp:Label ID="lbl_InPaxFeePrice" runat="server" Visible="false"></asp:Label>
                            ...
                            <tr id="trAVL" runat="server">
                                <td id="tdDepartAVL" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_num4" runat="server" Visible="false"></asp:Label>AVL Charge per Pax
                                ...
                                <td id="tdReturnAVL" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_InNum4" runat="server" Visible="false"></asp:Label>AVL Charge per Pax
                            ...
                            <tr id="trPSF" runat="server">
                                <td id="tdDepartPSF" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_num15" runat="server"></asp:Label>PSF Charge per Pax</span>
                                        <span class="infoFlightSpan algnRight">
                                ...
                                <td id="tdReturnPSF" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_InNum15" runat="server"></asp:Label>PSF Charge per Pax</span>
                                        <span class="infoFlightSpan algnRight">
                            ...
                            <tr id="trSCF" runat="server">
                                <td id="tdDepartSCF" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_num16" runat="server"></asp:Label>SCF Charge per Pax</span>
                                        <span class="infoFlightSpan algnRight">
                                ...
                                <td id="tdReturnSCF" runat="server">
                                    <div class="infoFlight">
                                        <span class="infoFlightSpan">
                                            <asp:Label ID="lbl_InNum16" runat="server"></asp:Label>SCF Charge per Pax</span>
                                        <span class="infoFlightSpan algnRight">
