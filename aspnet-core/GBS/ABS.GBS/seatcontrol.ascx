<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="seatcontrol.ascx.cs" Inherits="ABS.GBS.seatcontrol" %>
<link rel="stylesheet" type="text/css" href="../css/far-min.css" />
<script type="text/javascript" 
src="../js/AKBase/far-min.js"></script>
<script type="text/javascript" 
src="../js/AKBase/optimost.js"></script>
<script type="text/javascript" 
src="../js/AKBase/unitMap-min.js"></script>
...
<script type="text/javascript">
    ...
    //JM20120514
    function prepare_divenodevalue(parent, nodename, nodevalue) {
        var childs = parent.childNodes;
        for (var i = 0; i < childs.length; i++) {
            if (childs[i].nodeName == nodename) {
                if (childs[i].childNodes.length > 0)
                    if(nodevalue == childs[i].childNodes[0].nodeValue) {
                        return true;
                    }
                else
                    return false;
                ...
                for (var j = 0; j < childs[i].childNodes.length; j++) {
                    if(childs[i].nodeType == 1) {
                        if(prepare_divenodevalue(childs[i].childNodes[j],nodename,nodevalue)) {
                            return true;
                        }
                    }
                }
    ...
    function prepare_interfacing_variable(xmlhttp) {
        ...
        for (var i = 0; i < b.length; i++) {
            ...
            //JM20120514
            kquiet = prepare_divenodevalue(b[i], "TypeCode", "QUIET");
            if(kquiet) {
                k = parseInt(k,10)+19126;
            }
...
<div id="unitTipId" class="unitTip hidden">&lt;h3&gt; Information; &lt;/h3&gt; 
&lt;p&gt; Number: [unitDesignator] &lt;/p&gt; &lt;p&gt; Status: 
[unitAvailability] &lt;/p&gt; &lt;p&gt; Group: [unitGroup] &lt;/p&gt; &lt;p&gt; 
Fee: [unitFee] &lt;/p&gt; &lt;p&gt; 
