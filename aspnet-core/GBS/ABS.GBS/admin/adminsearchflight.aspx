<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsearchflight.aspx.cs" Inherits="GroupBooking.Web.admin.adminsearchflight" MasterPageFile="~/Master/NewAdminMaster.Master" %>
    ...
    <script type="text/javascript">
        ...
        function OnCallbackComplete(s, e) {
            if (e.result != "") {
                ...
                window.location.href = '../admin/adminselectflight.aspx';
            }
        }
