<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NewPageMaster.Master" AutoEventWireup="true" CodeBehind="ManageSeat.aspx.cs" Inherits="GroupBooking.Web.ManageSeat" %>
        ...
        <div class="col-sm-8">
            <div align="right" style="padding-top: 9px;" >
                <table id="bookingDetail">
                    <tr>
                        <td>
                            <dx:ASPxButton CssClass="buttonL backBtn"  ID="btn_back" runat="server"  
                                Text="Back" AutoPostBack="False" Visible="false" >
