<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NewPageMaster.Master" AutoEventWireup="true" CodeBehind="AddOn.aspx.cs" Inherits="GroupBooking.Web.AddOn" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script type="text/javascript" src="../Scripts/Booking/AddOn.js"></script>
    ...
    <div class="widget page-content container-fluid" style="border-color: transparent;">
                                ...
                                <div id="home" class="tab-pane fade in active">
                                    ...
                                    <dx:ASPxGridView ID="gvPassenger" runat="server" KeyFieldName="SeqNo;PassengerID" EnableRowsCache="false" EnableCallBacks="true"
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewCommandColumn Name="Action" Caption="Action" VisibleIndex="12" Width="70px">
                                                <CustomButtons>
                                        ...
                                        <SettingsText CommandBatchEditUpdate="Save Changes and Continue" CommandBatchEditCancel="Cancel Changes" />
                                    </dx:ASPxGridView>
                                </div>
                            </dx:ContentControl>
                        </ContentCollection>
        ...
        <script type="text/javascript">
            ...
            //    $('#home .buttonsWrapper > .col-sm-2').on('click', function () {
            //        $('#home .activeBtn').removeClass('activeBtn');
            //        $(this).children('a').addClass('activeBtn');
            //    });
            //    $('#home2 .buttonsWrapper > .col-sm-2').on('click', function () {
