...
{
    public partial class NewPageMasterReport : System.Web.UI.MasterPage
    {
        ...
        //    agProfileInfo = objAgentProfile.GetSingleAgentProfile(MyUserSet.UserName);
        //    if (agProfileInfo != null)
        //    {
        //        if (MyUserSet.SyncLastUpd != agProfileInfo.SyncLastUpd)
        //        {
