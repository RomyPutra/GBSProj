	  ...
	  <html>
		  <head>
			  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
				  <title>Air Asia Payment Notification</title>
				  <style type="text/css">
					  body {
					  font-size:11px;
					  margin-left: 0px;
        ...
        <td style="font-size:14px">
          <table style="background-color:#ffffff;" align="center" border="0" cellpadding="0" cellspacing="20" width="776">
            <tbody><tr>
				  ...
				  <tr>
					  <td style="font-size:14px">
						  <p><span style="font-family:Arial,sans-serif;">Thank you for completing payment for Transaction No: <b> {TransID} </b><br/> Booking No: <b> {PNR} </b> </span></p>
					  </td>
				  </tr>
				  <tr>
					  <td height="10" style="font-size:14px">
						  <p><span style="font-family:Arial,sans-serif;">
						     Thank you for choosing Air Asia. We wish you have a pleasant flight with us<br/>
							 </span>
						  </p>
					  </td>
				  </tr>
				  <tr>
					  <td style="font-size:14px">
						  <p>
						 <span style="font-family:Arial,sans-serif;">Kindly click on to this link <a href="http://172.30.2.253/GBS" target="_blank"> http://www.airasia.com/GBS</a> to Login and fill the passengers information. Thank you.  <br/></span>
