        ...
        <td style="font-size:14px">
          <table style="background-color:#ffffff;" align="center" border="0" cellpadding="0" cellspacing="20" width="776">
            <tbody><tr>
				  ...
				  <tr>
					  <td style="font-size:14px">
						  <p><span style="font-family:Arial,sans-serif;">Thank you for making payment for Transaction No: <b> {TransID} </b> with amount of <b>{Currency} {PaymentAmt} </b> </span></p>
					  </td>
				  </tr>
				  <tr>
					  <td height="10" style="font-size:14px">
						  <p><span style="font-family:Arial,sans-serif;">
						     There is still an outstanding balance payment of <b>{Currency} {BalanceDue} </b> which will be due on <b> {ExpiryDate} </b>.<br></br>
